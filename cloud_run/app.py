...
logger = logging.getLogger("gemini-chatbot-cloudrun")
...
app = FastAPI(
    title="Gemini Chatbot Web Service (Cloud Run)",
    description="Google Cloud Run 기반 Gemini 3.8 / 3.7 Flash 챗봇 백엔드"
)
...
if __name__ == "__main__":
    ...
    # Cloud Run 및 로컬 환경에서 0.0.0.0 바인딩
